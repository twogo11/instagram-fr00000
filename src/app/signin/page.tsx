...
const SignInPage = () => {
  ...
  return (
    <div className="flex w-full h-screen bg-black text-white gap-20">
      {/* Зүүн талд зураг */}
        ...
        <Card className="w-[350px] bg-black border-gray-800">
          <CardContent className="flex flex-col gap-4 p-8">
            ...
            <Button
              ...
              className="bg-[#385898] hover:bg-[#4b6cb7] w-full text-white mt-2"
            >
              Log in
            </Button>

            <div className="text-center text-sm mt-4">
              <a href="#" className="text-[#4b6cb7]">
                Forgot password?
              </a>
            </div>
